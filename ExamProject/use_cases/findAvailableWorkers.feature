...
#    And I have the activity "Bomb the Great Wall"
#    And the activity "Bomb the Great Wall" exists in the project with ID 184444
#    And the activity "Free Tibet" in the project with ID 184444 starts on week 6 of 2020 and ends on week 6 of 2020
#    And the worker "HAT" is assigned to the activity "Bomb the Great Wall" in the project with ID 184444
